    ...
    return (
        <div className='flex flex-col md:flex-row justify-between md:items-center border border-gray-300 p-2 rounded-lg gap-5'>
            <div className='flex items-center gap-3'>
                <img className='w-15 h-15 object-cover rounded-2xl' src={image} alt="" />
            ...
            <button onClick={() => handleUninstall(id)} className='btn bg-green-400 text-white'>Uninstall</button>
