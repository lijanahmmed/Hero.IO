    ...
    return (
        <div className='w-11/12 md:w-10/12 mx-auto mt-15'>
            ...
            <div className='mt-10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5'>
                {
                    treadingApps.map(app => <AppCard key={app.id} app={app}></AppCard>)
                }
            </div>
            <div className='mt-10 text-center pb-15'>
                <Link to='/apps' className='btn bg-gradient-to-r from-purple-600 to-purple-500 text-white py-6 px-10'>Show All</Link>
            </div>
        </div>
    );
};
