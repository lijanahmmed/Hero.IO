    ...
    <div>
      <div className="w-11/12 md:w-10/12 mx-auto text-center space-y-5 mt-15">
        ...
        <p className="text-4xl md:text-5xl font-bold">
          <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-600 to-purple-500 font-extrabold">
            Productive
          </span>{" "}
          Apps
        </p>
        <p className="text-gray-400 lg:w-8/12 mx-auto">
      ...
      <div className="flex justify-center gap-4 mt-6">
        <a href="https://play.google.com/" className="btn bg-white">
          <IoLogoGooglePlaystore className="text-xl"></IoLogoGooglePlaystore>{" "}
          Google Play
        </a>
        <a href="https://www.apple.com/app-store/" className="btn bg-white">
          <FaAppStoreIos className="text-xl"></FaAppStoreIos> App Store
        </a>
      </div>
